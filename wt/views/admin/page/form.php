<form method="post" id="mmForm">
	...
	<div class="row  ptb-5">
		<input type="text" name="page" value="{if $data}{# Str::decode($page_data['page'])}{/if}" id="page" class="mmPlaceholder wp-100 bsB mmTip" placeholder="Pagina naam" data-tip="Naam van pagina	" data-tip-position="right" data-tip-edge="left" />
	</div>
